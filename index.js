...
 encode_ssk,
 build_ssk,
} from "@analog-labs/timegraph-wasm";
...
 hashId: "<hash id of the View>",//lihat di watch.analog nya
 name: "<name of the view>",//lihat di watch.analog nya
});
...
 limit: "10", // <no of records required>
});
